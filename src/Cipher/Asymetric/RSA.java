...
public class RSA {
    ...
    public static String cipher(int val, Keys key) {
    ...
    public static String cipher(short val, Keys key) {
        BigInteger e = new BigInteger(key.pub,  16);
        BigInteger n = new BigInteger(key.n,  16);
        BigInteger v = new BigInteger(val+"");
        v = v.modPow(e, n);
    ...
    public static String cipher(long val, Keys key) {
        BigInteger e = new BigInteger(key.pub,  16);
        BigInteger n = new BigInteger(key.n,  16);
        BigInteger v = new BigInteger(val+"");
        v = v.modPow(e, n);
    ...
    public static long uncipher(String val, Keys key) {
